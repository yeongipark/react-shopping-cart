...
const apiClient = async ({
  ...
  const requestURL = `${"http://techcourse-lv2-alb-974870821.ap-northeast-2.elb.amazonaws.com"}` + URI;
...
const removeCartItem = async (id2) => {
  await apiClient({ method: "DELETE", URI: `/cart-items/${id2}` });
};
const increaseCartItem = async (id2, quantity) => {
  await apiClient({
    method: "PATCH",
    URI: `/cart-items/${id2}`,
    body: { quantity }
...
const decreaseCartItem = async (id2, quantity) => {
  await apiClient({
    method: "PATCH",
    URI: `/cart-items/${id2}`,
    body: { quantity }
...
function CartItem({
  ...
  const { decreaseQuantity, increaseQuantity, deleteCartItem, quantity } = useQuantityControl({
    initialQuantity,
...
function CartItemList({
  ...
  return /* @__PURE__ */ jsx$1("section", { css: Container$5, children: cartItems.map((cartItem) => {
...
function Receipt({ selectedCartItems }) {
  ...
  return /* @__PURE__ */ jsxs("div", { css: Container$2, children: [
    ...
    /* @__PURE__ */ jsx$1("table", { css: Table, children: /* @__PURE__ */ jsxs("tbody", { children: [
      ...
      /* @__PURE__ */ jsxs("tr", { children: [
        /* @__PURE__ */ jsx$1("td", { children: "배송비" }),
        /* @__PURE__ */ jsxs("td", { children: [
...
function Cart() {
  ...
  const fetchCartItem = reactExports.useCallback(
    () => fetchData({
